<?php 
    if (! empty($content)) {    // 수정 일때
        $mode = "edit";
        $confirmText = "주간 교육계획안을 수정하시겠습니까? ";
        $resultText = "수정 되었습니다.";
    } else {
        $mode = "write";
        $confirmText = "주간 교육계획안을 등록하시겠습니까? ";
        $resultText = "등록 되었습니다.";
    }
?>
        ...
        <form action="" method="post"  id="fileupload" enctype="multipart/form-data">
            ...
            <div class="note-week">
                ...
                <div class="week_select">
                    <select name="selctWeek" id="selctWeek" class="required" data-msg-required="주차를 선택하세요">
            ...
            <div class="btn_box" style="margin-top: 30px;">
                <button type="button" id="tempSaveBtn" data-target-area='{"name":"<?php echo $header['pn']; ?>","target":["month","selctWeek","noteTitle"]}' class="save left">임시저장</button>
